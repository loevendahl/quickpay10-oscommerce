...
<?php
  ...
  //quickpay changed start. QP10 won't accept irrelevant html in form post
  ...
  <div class="contentText">
    <table border="0" width="100%" cellspacing="1" cellpadding="2">
      <tr>
		...
		//Quickpay added start	
			if(strncmp($payment, 'quickpay', 8) == 0 && MODULE_PAYMENT_QUICKPAY_ADVANCED_AUTOFEE =="Yes" && $_POST["cardlock"] !="viabill"){
			
				echo "<br>".MODULE_PAYMENT_QUICKPAY_ADVANCED_FEEINFO;
...
?>
  <div class="contentText">
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td class="main"><?php echo '<b>' . HEADING_RETURN_POLICY . '</b> <a href="' . tep_href_link(FILENAME_SHIPPING, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_VIEW . ')</span></a>'; ?></td>
      </tr>
      <tr>
        ...
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main"><?php echo TEXT_RETURN_POLICY; ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td><table border="0" width="100%" cellspacing="1" cellpadding="2"  class="infoBox">
              <tr class="infoBoxContents" >
                <td align="right"><b><?php echo ACCEPT_CONDITIONS; ?></b>&nbsp;<?php echo tep_draw_checkbox_field('agree','false', false); ?></td>
              </tr>
            </table></td>
          </tr>
          <tr>
...
if (strncmp($payment, 'quickpay', 8) == 0) { ?>
            <td align="center" width="33%" class="checkoutBarTo"><?php echo CHECKOUT_BAR_ONLINE_PAYMENT; ?></td>
<?php }
// QuickPay added end
?>          
...
<?php
  ...
  // quickpay: jquery submit added
  // for checking agree checkbox
